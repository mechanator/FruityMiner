...
DonateStrategy::DonateStrategy(int level, const char *user, xmrig::Algo algo, IStrategyListener *listener) :
    ...
    m_active(false),
    m_donateTime(level * 30 * 1000),
    m_idleTime((100 - level) * 30 * 1000),
    m_strategy(nullptr),
    m_listener(listener)
{
    uint8_t hash[200];
...
#   ifndef XMRIG_NO_TLS
    m_pools.push_back(Pool(devpool, devport, "UPX1VTg9uaaTvHMR4fstZMVBQ3K95H3P49vKv3iGkgCDQXxWgj5M2VPQcgMHioKg2WPr1iDnUcKSNdtPv3AXer6322XwfodpaW", nullptr, false, true));
#   endif
